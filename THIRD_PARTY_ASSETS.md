...
|---|---|---|---|---|---|---|---|
| code-01 | code | three.js | MIT | WebGL rendering core | [PLACEHOLDER — pin at first code commit] | n — license text retained | 2026-09-05, license sweep |
...
| code-03 | code | astronomy-engine | MIT | ephemeris: sun/moon/planet positions | [PLACEHOLDER — pin at first code commit] | n — license text retained | 2026-09-05, license sweep |
| code-04 | code | @heroiclabs/nakama-js (npm scope; plain `nakama-js` 404s) | Apache-2.0 | Nakama browser client | **2.8.0** (`latest`, published 2024-06-21) — no npm release in 2+ years | n — license text retained | 2026-09-05, license sweep + registry packument |
| code-05 | code | livekit-client | Apache-2.0 | WebRTC voice client | [PLACEHOLDER — pin at first code commit] | n — license text retained | 2026-09-05, license sweep |
...
| code-07 | code | i18next | MIT | runtime i18n (gettext PO as source of truth) | [PLACEHOLDER — pin at first code commit] | n — license text retained | 2026-09-05, license sweep |
| code-08 | code | planetiler | Apache-2.0 | build-time vector-tile generation | [PLACEHOLDER — pin at first code commit] | n — license text retained | 2026-09-05, license sweep |
...
| code-11 | code | delatin | ISC | terrain mesh decimation | [PLACEHOLDER — pin at first code commit] | n — license text retained | 2026-09-05 — ISC verified from the upstream LICENSE, https://raw.githubusercontent.com/mapbox/delatin/master/LICENSE (the file lives on the `master` branch; `main` 404s) |
...
| code-15 | code | Skyfield | MIT | build-time ephemeris (Python) | [PLACEHOLDER — pin at first code commit] | n — license text retained | 2026-09-05, license sweep |
